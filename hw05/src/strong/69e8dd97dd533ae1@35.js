...
function _strong1(d3,data1,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1000;
  const height = 400;
  ...
  // 計算圖形並啟動力模擬。 //調整組別（第一組）
  const root = d3.hierarchy(data1.children[1]); 
  const links = root.links();
  const nodes = root.descendants();
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    ["data(1).json", {url: new URL("./files/f2564cfa41b0bc5c2097fd52c9b01237a981e5a81f4b1f0ab129f86c61216f8de0d6da4df3b10dd28515247c3dd9f0a0a3e5a2236e962adc35e70199b0f11df6.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable(observer("strong1")).define("strong1", ["d3","data1","drag","url_list","invalidation"], _strong1);
